-- =====================================================================================
-- BE-SEC-003 — Diagnostik keadaan technical permission pilot Dokter Rawat Jalan
--
...
--   Bagian A–C  : metrik dasar, dibandingkan dengan baseline lama.
...
--   ADA di registry tetapi BELUM diberikan kepada siapa pun — ditolak 403 untuk semua
...
\echo ''
\echo '==== F. Ringkasan per identitas — mana yang sudah punya hak, mana yang KOSONG ===='
...
\echo ''
\echo '==== SELESAI — tidak ada data yang diubah ===='
