...
namespace QuilvianSystemBackend.Repositories.Configurations.HealthService
{
    public class MstInsuranceCoverageRuleConfiguration : IEntityTypeConfiguration<MstInsuranceCoverageRule>
    {
        public void Configure(EntityTypeBuilder<MstInsuranceCoverageRule> entity)
        {
            ...
            entity.Property(x => x.CoverageStatus).HasMaxLength(50).HasDefaultValue("Covered").IsRequired();
            entity.Property(x => x.CoveragePercent).HasColumnType("numeric(5,2)").HasDefaultValue(100);
            ...
            entity.Property(x => x.ApprovalInstruction).HasMaxLength(250);
            ...
            entity.HasOne(x => x.DrugCategory).WithMany().HasForeignKey(x => x.DrugCategoryId).OnDelete(DeleteBehavior.Restrict);
            ...
            entity.HasIndex(x => new { x.InsuranceProviderId, x.BenefitPlanCode, x.PatientClassId, x.ItemType, x.Priority, x.IsActive, x.IsDelete });
