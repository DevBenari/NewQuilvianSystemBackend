...
{
    public class EmgVisitConfiguration : IEntityTypeConfiguration<EmgVisit>
    {
        public void Configure(EntityTypeBuilder<EmgVisit> builder)
        {
            builder.ToTable("EmgVisit", "public");
