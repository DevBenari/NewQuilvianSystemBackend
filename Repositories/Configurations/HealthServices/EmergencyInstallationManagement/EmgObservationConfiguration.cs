...
{
    public class EmgObservationConfiguration : IEntityTypeConfiguration<EmgObservation>
    {
        public void Configure(EntityTypeBuilder<EmgObservation> builder)
        {
            builder.ToTable("EmgObservation", "public");
