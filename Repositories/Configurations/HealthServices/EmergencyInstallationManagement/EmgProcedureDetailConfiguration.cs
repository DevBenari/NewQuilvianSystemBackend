...
{
    public class EmgProcedureDetailConfiguration : IEntityTypeConfiguration<EmgProcedureDetail>
    {
        public void Configure(EntityTypeBuilder<EmgProcedureDetail> builder)
        {
            builder.ToTable("EmgProcedureDetail", "public");
