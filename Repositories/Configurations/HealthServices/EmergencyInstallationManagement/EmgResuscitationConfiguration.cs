...
{
    public class EmgResuscitationConfiguration : IEntityTypeConfiguration<EmgResuscitation>
    {
        public void Configure(EntityTypeBuilder<EmgResuscitation> builder)
        {
            builder.ToTable("EmgResuscitation", "public");
