...
{
    public class EmgDispositionTypeConfiguration : IEntityTypeConfiguration<EmgDispositionType>
    {
        public void Configure(EntityTypeBuilder<EmgDispositionType> builder)
        {
            builder.ToTable("EmgDispositionType", "public");
