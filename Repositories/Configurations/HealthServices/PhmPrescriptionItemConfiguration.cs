...
{
    public class PhmPrescriptionItemConfiguration : IEntityTypeConfiguration<PhmPrescriptionItem>
    {
        public void Configure(EntityTypeBuilder<PhmPrescriptionItem> entity)
        {
            entity.ToTable("PhmPrescriptionItem", "public");
