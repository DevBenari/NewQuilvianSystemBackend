...
{
    public class PhmPrescriptionCompoundItemConfiguration : IEntityTypeConfiguration<PhmPrescriptionCompoundItem>
    {
        public void Configure(EntityTypeBuilder<PhmPrescriptionCompoundItem> entity)
        {
            entity.ToTable("PhmPrescriptionCompoundItem", "public");
