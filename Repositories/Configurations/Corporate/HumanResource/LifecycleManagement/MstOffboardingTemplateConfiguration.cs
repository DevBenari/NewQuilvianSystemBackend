...
{
    public class MstOffboardingTemplateConfiguration : IEntityTypeConfiguration<MstOffboardingTemplate>
    {
        public void Configure(EntityTypeBuilder<MstOffboardingTemplate> builder)
        {
            builder.ToTable("MstOffboardingTemplate", "public");
            ...
            builder.HasIndex(x => new { x.LegalEntityId, x.HospitalSiteId, x.SeparationType, x.IsActive });
        }
    }
}
