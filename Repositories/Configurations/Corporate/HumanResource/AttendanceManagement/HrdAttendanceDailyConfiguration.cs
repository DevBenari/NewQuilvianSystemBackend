...
{
    public class HrdAttendanceDailyConfiguration : IEntityTypeConfiguration<HrdAttendanceDaily>
    {
        public void Configure(EntityTypeBuilder<HrdAttendanceDaily> builder)
        {
            builder.ToTable("HrdAttendanceDaily", "public");
