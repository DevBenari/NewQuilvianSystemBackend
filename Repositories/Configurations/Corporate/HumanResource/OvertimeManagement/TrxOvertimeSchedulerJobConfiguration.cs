...
{
    public class TrxOvertimeSchedulerJobConfiguration : IEntityTypeConfiguration<TrxOvertimeSchedulerJob>
    {
        public void Configure(EntityTypeBuilder<TrxOvertimeSchedulerJob> builder)
        {
            builder.ToTable("TrxOvertimeSchedulerJob", "public");
            ...
            builder.Property(x => x.JobType)
                .HasMaxLength(40)
                .HasDefaultValue(OvertimeValueConstants.SchedulerJobType.FullCycle)
                .IsRequired();
            builder.Property(x => x.JobStatus)
                .HasMaxLength(30)
                .HasDefaultValue(OvertimeValueConstants.SchedulerJobStatus.Pending)
                .IsRequired();
            ...
            builder.HasOne(x => x.OvertimePeriod).WithMany(x => x.SchedulerJobs).HasForeignKey(x => x.OvertimePeriodId).OnDelete(DeleteBehavior.Restrict);
            ...
            builder.HasIndex(x => new { x.OvertimePeriodId, x.JobStatus });
