...
{
    public class MstLeaveCarryForwardPolicyConfiguration : IEntityTypeConfiguration<MstLeaveCarryForwardPolicy>
    {
        public void Configure(EntityTypeBuilder<MstLeaveCarryForwardPolicy> entity)
        {
            ...
            entity.Property(x => x.LeaveEntitlementPolicyId).IsRequired();
            ...
            entity.Property(x => x.MaximumCarryForwardDays).HasPrecision(8, 2).IsRequired(false);
            entity.Property(x => x.CarryForwardPercentage).HasPrecision(5, 2).HasDefaultValue(100m);
            ...
            entity.Property(x => x.PayoutMaximumDays).HasPrecision(8, 2).IsRequired(false);
            ...
            entity.HasIndex(x => x.LeaveEntitlementPolicyId);
            entity.HasIndex(x => new { x.LeaveEntitlementPolicyId, x.IsCarryForwardEnabled, x.IsDefault, x.IsActive, x.IsDelete });
            entity.HasIndex(x => new { x.ExpiryMethod, x.IsPayoutAllowed, x.ExcessBalanceAction });
