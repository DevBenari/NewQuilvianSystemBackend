...
namespace QuilvianSystemBackend.Repositories.Configurations.Corporate.HumanResource.MasterData.Workforce
{
    public class MstEmployeeConfiguration : IEntityTypeConfiguration<MstEmployee>
    {
        public void Configure(EntityTypeBuilder<MstEmployee> entity)
        {
            ...
            entity.Property(x => x.BirthDate).HasColumnType("date").IsRequired();
            ...
            entity.Property(x => x.IdentityType).HasMaxLength(50).IsRequired();
            entity.Property(x => x.IdentityNumber).HasMaxLength(16).IsRequired();
            entity.Property(x => x.PhoneNumber).HasMaxLength(13);
            entity.Property(x => x.WhatsAppNumber).HasMaxLength(13);
            entity.Property(x => x.Email).HasMaxLength(200).IsRequired();
            entity.Property(x => x.Address).HasMaxLength(500);

            entity.Property(x => x.PrimaryDepartmentId).IsRequired();
            entity.Property(x => x.PrimaryPositionId).IsRequired();
            ...
            entity.Property(x => x.EmergencyContactPhone).HasMaxLength(13);
            entity.Property(x => x.EmergencyContactAddress).HasMaxLength(500);
            ...
            entity.HasOne(x => x.EmploymentStatus)
                .WithMany()
            ...
            entity.HasOne(x => x.WorkerSource)
                .WithMany()
                .HasForeignKey(x => x.WorkerSourceId)
                .OnDelete(DeleteBehavior.Restrict);
            ...
            entity.HasIndex(x => x.EmployeeNumber).IsUnique().HasFilter("\"IsDelete\" = false");
            entity.HasIndex(x => x.IdentityNumber).IsUnique().HasFilter("\"IdentityNumber\" IS NOT NULL AND \"IsDelete\" = false");
            entity.HasIndex(x => x.Email).IsUnique().HasFilter("\"Email\" IS NOT NULL AND \"IsDelete\" = false");
