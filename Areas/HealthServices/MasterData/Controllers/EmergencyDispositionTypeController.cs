...
namespace QuilvianSystemBackend.Areas.HealthServices.MasterData.EmergencyInstallationManagement.Controllers
{
    [ApiController]
    [Authorize]
    [Route("api/v1/health-services/master-data/emergency-installation-management/emergency-disposition-types")]
    [AccessController(
    ...
    [Tags("Health Services / Master Data / Emergency Installation Management / Emergency Disposition Type")]
