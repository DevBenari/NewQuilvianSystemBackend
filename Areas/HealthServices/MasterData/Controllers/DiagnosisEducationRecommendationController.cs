...
namespace QuilvianSystemBackend.Areas.HealthServices.MasterData.Controllers
{
    ...
    public class DiagnosisEducationRecommendationController : ControllerBase
    {
        ...
        private static readonly string[] EducationTypeOptions = { "General", "Diet", "Activity", "MedicationUse", "WarningSign", "FollowUp", "Prevention" };
        ...
        public async Task<IActionResult> GetFilterMetadata()
        {
            var result = new DiagnosisEducationRecommendationFilterMetadataResponse
            {
                ...
                EducationTypeOptions = EducationTypeOptions.Select(x => new DiagnosisEducationRecommendationStringOptionResponse { Value = x, Label = BuildLabel(x) }).ToList(),
        ...
        public async Task<IActionResult> GetRecommendations(
            ...
            [FromQuery] string? educationType,
            ...
            [FromQuery] int pageSize = 25)
        {
            ...
            query = ApplyStandardFilter(query, search, diagnosisId, educationType, isActive);
        ...
        [AccessPermission("DiagnosisEducationRecommendation", "Read")]
        public async Task<IActionResult> GetRecommendationOptions([FromQuery] Guid? diagnosisId, [FromQuery] string? educationType, [FromQuery] bool onlyActive = true, [FromQuery] string? search = null, [FromQuery] int take = 100)
        {
            if (take <= 0) take = 100;
            if (take > 200) take = 200;
            var query = BuildBaseQuery();
            query = ApplyStandardFilter(query, search, diagnosisId, educationType, onlyActive ? true : null);
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            ...
            if (entity == null) return NotFound(ApiResponse<object>.Fail(StatusCodes.Status404NotFound, "Rekomendasi edukasi diagnosis tidak ditemukan."));
        ...
        public async Task<IActionResult> CreateRecommendation([FromBody] CreateDiagnosisEducationRecommendationRequest request)
        {
            ...
            if (!validation.IsValid) return BadRequest(ApiResponse<object>.Fail(StatusCodes.Status400BadRequest, validation.ErrorMessage ?? "Data rekomendasi edukasi diagnosis tidak valid."));
        ...
        [ProducesResponseType(typeof(ApiResponse<DiagnosisEducationRecommendationUpdateResponse>), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
        [AccessAction("Update", "Update Diagnosis Education Recommendation", Description = "Mengubah status rekomendasi edukasi diagnosis", AccessType = AccessTypes.Update, SortOrder = 3)]
        [AccessPermission("DiagnosisEducationRecommendation", "Update")]
        public async Task<IActionResult> UpdateRecommendationStatus(Guid id, [FromBody] UpdateDiagnosisEducationRecommendationStatusRequest request)
        {
            ...
            var loaded = await BuildBaseQuery().FirstAsync(x => x.Id == entity.Id);
            var actorNames = await GetActorNameMapAsync(new[] { actorUserId });
            return Ok(ApiResponse<DiagnosisEducationRecommendationUpdateResponse>.Ok(ToUpdateResponse(loaded, actorNames), "Status rekomendasi edukasi diagnosis berhasil diubah."));
        }
        ...
        {
            return _dbContext.Set<MstDiagnosisEducationRecommendation>().AsNoTracking().Include(x => x.Diagnosis).Where(x => !x.IsDelete);
        }
        ...
        private static IQueryable<MstDiagnosisEducationRecommendation> ApplyStandardFilter(IQueryable<MstDiagnosisEducationRecommendation> query, string? search, Guid? diagnosisId, string? educationType, bool? isActive)
        {
        ...
        private static IOrderedQueryable<MstDiagnosisEducationRecommendation> ApplySorting(IQueryable<MstDiagnosisEducationRecommendation> query, string? sortBy, string? sortDirection)
        {
            ...
            return (sortBy ?? "diagnosisCode").Trim().ToLowerInvariant() switch
            {
                ...
                _ => isDesc ? query.OrderByDescending(x => x.Diagnosis != null ? x.Diagnosis.DiagnosisCode : string.Empty).ThenByDescending(x => x.EducationTitle) : query.OrderBy(x => x.Diagnosis != null ? x.Diagnosis.DiagnosisCode : string.Empty).ThenBy(x => x.EducationTitle)
            };
        }
        ...
        private async Task<(bool IsValid, string? ErrorMessage)> ValidateRequestAsync(Guid? currentId, CreateDiagnosisEducationRecommendationRequest request)
        {
            ...
            if (!EducationTypeOptions.Contains(request.EducationType, StringComparer.OrdinalIgnoreCase)) return (false, "Tipe edukasi tidak valid.");
        ...
        private static List<DiagnosisEducationRecommendationSortOptionResponse> BuildSortOptions() => new()
        {
            ...
            new() { Value = "educationType", Label = "Tipe edukasi" },
            new() { Value = "educationTitle", Label = "Judul edukasi" },
        ...
        private static List<DiagnosisEducationRecommendationQueryParameterInfoResponse> BuildQueryParameterInfo() => new()
        {
            ...
            new() { Name = "search", Type = "string", Description = "Cari diagnosis, tipe edukasi, judul edukasi, atau isi edukasi." },
            new() { Name = "diagnosisId", Type = "Guid?", Description = "Filter berdasarkan diagnosis." },
            new() { Name = "educationType", Type = "string", Description = "Filter tipe edukasi.", Example = "Diet" },
        ...
        private static List<DiagnosisEducationRecommendationFormFieldMetadataResponse> BuildFieldMetadata(bool isUpdate)
        {
            var fields = new List<DiagnosisEducationRecommendationFormFieldMetadataResponse>
            {
                ...
                new() { Name = "educationTitle", Label = "Judul Edukasi", Section = "Basic", InputType = "text", IsRequiredOnCreate = true, IsRequiredOnUpdate = true, RequiredType = "Required", MaxLength = 250, Example = "Diet rendah garam", SortOrder = 3 },
                new() { Name = "educationText", Label = "Isi Edukasi", Section = "Education", InputType = "textarea", IsRequiredOnCreate = true, IsRequiredOnUpdate = true, RequiredType = "Required", MaxLength = 2000, SortOrder = 4 }
            };
