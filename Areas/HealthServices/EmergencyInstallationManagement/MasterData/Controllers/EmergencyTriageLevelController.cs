...
namespace QuilvianSystemBackend.Areas.HealthServices.EmergencyInstallationManagement.MasterData.Controllers
{
    [ApiController]
    [Authorize]
    [Route("api/v1/health-services/emergency-installation-management/master-data/emergency-triage-levels")]
    [AccessController(
    ...
    [Tags("Health Services / Emergency Installation Management / Master Data / Emergency Triage Level")]
