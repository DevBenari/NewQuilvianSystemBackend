...
namespace QuilvianSystemBackend.Areas.Corporate.HumanResource.WorkflowManagement.Models
{
    ...
    public class TrxWorkflowStepInstance : IdentityModel
    {
        ...
        [Required]
        [MaxLength(50)]
        public string StepTypeSnapshot { get; set; } = "Approval";

        [Required]
        [MaxLength(50)]
        public string ApprovalModeSnapshot { get; set; } = "Any";

        [Required]
        [MaxLength(50)]
        public string ApproverSourceSnapshot { get; set; } = "DirectManager";
