...
{
    [Table("TrxEmployeeDemotion", Schema = "public")]
    public class TrxEmployeeDemotion : IdentityModel
    {
        public Guid Id { get; set; } = Guid.NewGuid();
        [Required] public Guid WorkforceProfileId { get; set; }
        public Guid? WorkflowDefinitionId { get; set; }
        [Required, MaxLength(50)] public string DemotionNumber { get; set; } = string.Empty;
        [Required, MaxLength(50)] public string DemotionStatus { get; set; } = "Draft";
