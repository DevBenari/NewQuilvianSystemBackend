...
{
    [Table("TrxMedicalServiceFeePayment", Schema = "public")]
    public class TrxMedicalServiceFeePayment : IdentityModel
    {
        public Guid Id { get; set; } = Guid.NewGuid();

        [Required]
        public Guid MedicalServiceFeeCalculationId { get; set; }
        ...
        // Draft, Scheduled, Processing, Paid, Failed, Reversed, Cancelled.
        ...
        public TrxMedicalServiceFeeCalculation? MedicalServiceFeeCalculation { get; set; }
