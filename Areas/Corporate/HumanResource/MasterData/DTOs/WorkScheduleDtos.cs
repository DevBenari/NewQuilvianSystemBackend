...
namespace QuilvianSystemBackend.Areas.Corporate.HumanResource.MasterData.DTOs
{
    ...
    public class WorkScheduleOptionPagedResponse
    {
        ...
        public List<WorkScheduleOptionResponse> Items { get; set; } = new();
    }
    ...
    public class WorkScheduleFilterMetadataResponse
    {
        ...
        public List<WorkScheduleCustomPeriodOptionResponse> CustomPeriods { get; set; } = new();
    ...
    public class WorkScheduleCustomPeriodOptionResponse
    {
