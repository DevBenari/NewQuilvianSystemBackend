...
namespace QuilvianSystemBackend.Areas.Corporate.HumanResource.MasterData.Workforce.DTOs
{
    ...
    public class EmployeeMasterOptionResponse
    {
    ...
    public class EmployeeFilterMetadataResponse
    {
        ...
        public List<EmployeeMasterOptionResponse> WorkforceTypeOptions { get; set; } = new();

        public List<EmployeeMasterOptionResponse> EmployeeCategoryOptions { get; set; } = new();

        public List<EmployeeMasterOptionResponse> EmploymentTypeOptions { get; set; } = new();

        public List<EmployeeMasterOptionResponse> EmploymentStatusOptions { get; set; } = new();

        public List<EmployeeMasterOptionResponse> ContractTypeOptions { get; set; } = new();

        public List<EmployeeMasterOptionResponse> WorkerSourceOptions { get; set; } = new();

        public List<EmployeeMasterOptionResponse> ProfessionOptions { get; set; } = new();

        public List<EmployeeMasterOptionResponse> JobFamilyOptions { get; set; } = new();
