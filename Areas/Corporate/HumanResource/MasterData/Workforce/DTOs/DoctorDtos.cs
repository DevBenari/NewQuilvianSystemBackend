...
namespace QuilvianSystemBackend.Areas.Corporate.HumanResource.MasterData.Workforce.DTOs
{
    ...
    public class DoctorResponse
    {
        ...
        public ClinicalPrivilegeStatus ClinicalPrivilegeStatus { get; set; }
    ...
    public class DoctorMasterOptionResponse
    {
    ...
    public class DoctorFilterMetadataResponse
    {
        ...
        public List<DoctorMasterOptionResponse> WorkforceTypeOptions { get; set; } = new();

        public List<DoctorMasterOptionResponse> EmployeeCategoryOptions { get; set; } = new();

        public List<DoctorMasterOptionResponse> EmploymentTypeOptions { get; set; } = new();

        public List<DoctorMasterOptionResponse> EmploymentStatusOptions { get; set; } = new();

        public List<DoctorMasterOptionResponse> ContractTypeOptions { get; set; } = new();

        public List<DoctorMasterOptionResponse> WorkerSourceOptions { get; set; } = new();

        public List<DoctorMasterOptionResponse> ProfessionOptions { get; set; } = new();

        public List<DoctorMasterOptionResponse> SpecializationOptions { get; set; } = new();

        public List<DoctorEnumOptionResponse> PracticeTypeOptions { get; set; } = new();

        public List<DoctorEnumOptionResponse> CredentialingStatusOptions { get; set; } = new();

        public List<DoctorEnumOptionResponse> ClinicalPrivilegeStatusOptions { get; set; } = new();
