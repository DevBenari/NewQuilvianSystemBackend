...
namespace QuilvianSystemBackend.Areas.Corporate.HumanResource.MasterData.Workforce.DTOs
{
    ...
    public class ExternalUserMasterOptionResponse
    {
    ...
    public class ExternalUserFilterMetadataResponse
    {
        ...
        public List<ExternalUserMasterOptionResponse> WorkforceTypeOptions { get; set; } = new();

        public List<ExternalUserMasterOptionResponse> EmployeeCategoryOptions { get; set; } = new();

        public List<ExternalUserMasterOptionResponse> EmploymentTypeOptions { get; set; } = new();

        public List<ExternalUserMasterOptionResponse> ContractTypeOptions { get; set; } = new();

        public List<ExternalUserMasterOptionResponse> WorkerSourceOptions { get; set; } = new();

        public List<ExternalUserMasterOptionResponse> ProfessionOptions { get; set; } = new();

        public List<ExternalUserMasterOptionResponse> JobFamilyOptions { get; set; } = new();
