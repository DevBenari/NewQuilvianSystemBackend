...
| `FE-IGD-017` | `FR-IGD-036`…`043` | `IGD-06` | `MVP-4` | — | `BE-IGD-033`, `034` | 🟡 21 September 2026 (larut malam): **kriteria 1 kini di source** — pelaku dan penyetuju dibaca sebagai nama (`IGD-DEC-137`, `BE-IGD-049`); eslint 0 error, 5 test baru lulus; **uji layar pemilik LULUS** (pelaku `SuperAdmin`, bukan GUID); tersisa `npm run build` revisi ini (`IGD-EV-123` butir 2) | [FE-IGD-017](../task/report/frontend/FE-IGD-017.md) |
...
| `FE-IGD-017` 🟡 | `FR-IGD-036`…`043`; `IGD-DEC-137` | Dua ruas nama pada tab kepergian, sesudah backend | `BE-IGD-033` ✅, `BE-IGD-034` ✅, **`BE-IGD-049` 🟡 (build terverifikasi — boleh dimulai)** | Ya | Ya | Kriteria 2–3 ✅; **kriteria 1 Implementation Complete** (21 Sep 2026 larut malam; lint 0 error, 5 test baru; [laporan](../task/report/frontend/FE-IGD-017.md)) | **Uji layar LULUS** (21 Sep 2026 larut malam, [laporan](../task/report/frontend/FE-IGD-017.md) 6.1); build revisi ini belum dilaporkan |
