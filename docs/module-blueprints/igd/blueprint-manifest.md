...
| `revision` | **`7`** — naik 22 September 2026 (penutup) lewat `IGD-DEC-157`: bagian encounter-first kelima kontrak `approved`. *Sebelumnya `6`* |
...
| `approved_at` | Sebagian: `2026-08-24`; `2026-09-22` (encounter-first) |
