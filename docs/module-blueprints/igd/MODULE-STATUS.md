...
| `MVP-5` | Riwayat dokter & serah terima (`BE-IGD-035`; `EPIC IGD-04`) | `IN_PROGRESS` 🟡 | `BE-IGD-035` kriteria 2 (dikerjakan `BE-IGD-041`); `EPIC IGD-04`: **`BE-IGD-045` ✅ terverifikasi runtime 17 September 2026** (12/12 skenario `PASS`); `BE-IGD-044` 🟡 (acceptance 4 pindah ke `BE-IGD-048`, acceptance 5 menunggu uji langkah mundur); `BE-IGD-048` ✅ **21 September 2026** — migration diterapkan ke dev, kriteria A–E dan siklus `Up→Down→Up` terbukti di salinan basis data terpisah, kontrak `0.8.0` ([laporan](task/report/backend/BE-IGD-048.md)); **`FE-IGD-027` 🟡 (dinilai ulang 21 September 2026)** — runtime inti terverifikasi 18 September 2026 **pada revisi `3213419a7`** (13 pemeriksaan lewat layar `PASS`); source berubah sesudahnya (terminologi + "Data historis") dan **build penuh revisi terbaru belum diverifikasi pemilik**. `EPIC IGD-04` tuntas kecuali build penuh frontend revisi terbaru itu dan uji `Down` migration asli (`BE-IGD-044` acceptance 5). **Ditambahkan 17 September 2026:** runtime sikap pesanan tertahan `BE-IGD-039` |
...
| Lapisan | Rumus | Hasil |
| --- | --- | --- |
| Backend | task ✅ / seluruh task roadmap | **23 / 33 = 70%** (`BE-IGD-048` ✅ 21 September 2026; sebelumnya 22 / 33 = 67% sesudah `BE-IGD-045` ✅ 17 September 2026). `BE-IGD-044` 🟡 belum dihitung ✅ (dihitung ulang 17 September 2026 dari *Register status task* `backend-roadmap.md`). Tidak dikecualikan: `BE-IGD-039` dan `BE-IGD-042` (⛔) tetap dihitung di penyebut. *Sebelumnya tertulis 18 / 29 = 62% — usang sejak `BE-IGD-040` dan `BE-IGD-046` ✅ dan `BE-IGD-046` masuk register* |
| Frontend | task ✅ / seluruh task roadmap | **14 / 24 = 58%** (`FE-IGD-027` dinilai ulang 🟡 21 September 2026 — build penuh revisi terbaru belum diverifikasi pemilik; sebelumnya 15 / 24 = 63%) (dihitung ulang 17 September 2026 sesudah uji layar pemilik). ✅: `FE-IGD-015`, `016`, `018`, `019`, `020`, `021`, `023`, `024`, `028`, **`029`**, `030`, **`031`**, **`032`**, **`033`**. *Sebelumnya tertulis 6 / 17 = 35% — usang sejak `FE-IGD-023`, `024`, `028`, `030` ✅ dan `FE-IGD-029`…`032` masuk register* |
