...
| `AC-194` — penurunan tepat satu saat pemetaan disimpan | **Nol dibuktikan, dan sengaja** | `NOT RUN` | Grup pemetaan **nol punya `DELETE`**, sehingga membuat satu pemetaan uji **nol dapat dibatalkan** pada database dev bersama |
