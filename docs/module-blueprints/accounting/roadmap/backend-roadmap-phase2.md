...
| `BE-ACC-P2-017` 🟡 | API Jenis Kejadian | `P2-0b` | `015` ✅ | 🟡 **SEBAGIAN** 14 Sep 2026 — 6 dari 6 acceptance di source; build ulang terpenuhi (0 error, 192 warning) dan `016` ✅ diterapkan; sisa hanya uji panggil `GET /event-types` dan `GET /posting-rules` dengan login — rute terbukti terdaftar (`401`/`404`) 15.20 WIB, respons `200` belum ada. [Laporan](../task/report/backend/BE-ACC-P2-017.md) |
