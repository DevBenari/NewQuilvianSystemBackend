...
| `MVP-1` Jurnal manual | `BE-ACC-007` sampai `BE-ACC-011` | `BE-ACC-007`..`011` **`DONE`** | `MVP-0` selesai ✅ |
...
| **Status** | **`DONE`** — 3 September 2026, acceptance terbukti test terhadap PostgreSQL sungguhan (33 test `BE-ACC-011`..`014`, 0 gagal). Laporan: [`../task/report/backend/be-acc-011-jurnal-pengajuan-persetujuan-pengesahan.md`](../task/report/backend/be-acc-011-jurnal-pengajuan-persetujuan-pengesahan.md) |
...
| **Status** | **`DONE`** — 3 September 2026, acceptance terbukti test. Verifikasi performa tetap tertunda sampai ada data menyerupai produksi (`ACC-TD-018`). Laporan: [`../task/report/backend/be-acc-012-buku-besar-dan-neraca-saldo.md`](../task/report/backend/be-acc-012-buku-besar-dan-neraca-saldo.md) |
...
| DoD | Acceptance terbukti test, laporan task tersedia |
| **Status** | **`DONE`** — 3 September 2026, acceptance terbukti test. Laporan: [`../task/report/backend/be-acc-013-pembalikan-dan-jurnal-penyesuaian.md`](../task/report/backend/be-acc-013-pembalikan-dan-jurnal-penyesuaian.md) |
...
| DoD | Acceptance terbukti test, laporan task tersedia |
| **Status** | **`DONE`** — 3 September 2026, **nol baris kode berubah**; acceptance terbukti test atas jalur yang sudah ada. Laporan: [`../task/report/backend/be-acc-014-saldo-awal.md`](../task/report/backend/be-acc-014-saldo-awal.md) |
