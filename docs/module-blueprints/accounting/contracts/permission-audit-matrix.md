...
1. `AccountingEvent : Receive` **tidak dimiliki satu pun dari tujuh peran manusia** — termasuk
   ...
   **penugasan Departemen + Jabatan khusus akun layanan Finance** (misalnya Departemen "Integrasi
   ...
   dimaksudkan, dan Administrator adalah manusia. Syarat lain dari `ACC-DEC-088`: akun itu bukan
   SuperAdmin, dan berhak atas badan hukum yang dikirimi kejadian. **Tanpa penugasan organisasi,
   setiap kiriman Finance pasti `403`**, karena `SysAccessPolicy` memberikan hak per Departemen +
   Jabatan. Mekanisme login akun layanan belum diputuskan (Platform + Yasmin + Rizki).
