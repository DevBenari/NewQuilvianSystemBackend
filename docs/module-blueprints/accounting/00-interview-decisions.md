...
| Revision | `6` — dinaikkan 10 September 2026; `ACC-DEC-070` memperluas `ACC-DEC-051` menjadi enam peringatan dan menutup `ACC-GAP-012`. Sebelumnya `5` (`ACC-DEC-067`, `068`, `069` meratifikasi tiga delta yang menggantung dan menutup `DEC-ACC-P2-006`), dan `4`, 8 September 2026 oleh Amendment pass Phase 2 |
