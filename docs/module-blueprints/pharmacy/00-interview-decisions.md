...
| Kapabilitas | Sebab |
|---|---|
| Copy resep | `PHA-DEC-058`; **`BLOCKED_BY_DISPENSING_CAPABILITY`** — bukan oleh SIA/SIPA |
| Pencatatan penyerahan obat per item | `PHA-DEC-059`; prasyarat tunggal copy resep, belum dibangun |
