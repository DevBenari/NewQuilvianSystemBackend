...
Ini pertahanan paling langsung terhadap duplikasi entity. Setiap baris "Dibuat ulang di modul ini"
yang berisi "Ya" wajib punya alasan.

| Kelompok data | Modul pemilik | Dipakai modul ini | Dibuat ulang di modul ini |
| --- | --- | :---: | --- |
| Pasien | Patient Management | Ya | Tidak — dirujuk lewat kunjungan |
| Kunjungan pasien | Registration Management | Ya | Tidak — `InpEpisode.EncounterId` |
| Penjamin kunjungan | Registration Management | Ya | Tidak — dibaca lewat kunjungan |
| Tempat tidur, kamar, unit layanan, kelas pasien | Master Data HealthServices | Ya | Tidak — dirujuk lewat Id |
| Status ketersediaan tempat tidur | Master Data HealthServices | Ya | Tidak — **ditulis** modul ini sebagai salinan, lihat bagian 2.1 |
| Dokter | Corporate HR Workforce | Ya | Tidak — `InpDoctorAssignment.DoctorId` |
| Pegawai dan profil tenaga kerja | Corporate HR Workforce | Ya | Tidak — `InpNurseAssignment.EmployeeId` |
| Episode rawat inap | **InPatient Management** | Ya | **Ya** — konsep baru, tidak ada pemiliknya di mana pun |
| Pemesanan dan penempatan tempat tidur | **InPatient Management** | Ya | **Ya** — konsep baru; hari ini tidak ada satu pun catatan penghunian di dalam sistem |
| Penanggung jawab episode (DPJP dan perawat) | **InPatient Management** | Ya | **Ya** — berbentuk riwayat berperiode, berbeda dari kolom dokter pada kunjungan |
| Resume pulang | **InPatient Management** | Ya | **Ya** — catatan resmi episode, berbeda dari surat keterangan milik Clinical Management |
| Kelayakan keuangan | **InPatient Management** | Ya | **Ya, sementara** — sampai `BillingManagement` punya kemampuan transaksi, sesuai `RWI-RULE-028` aturan 7 |
