...
| `CAP-012` Nursing Assessment | `EPIC KEP-02` | `FR-KEP-005` s.d. `FR-KEP-011` | `BE-RWI-055` ✅, `BE-RWI-056` 🟡, `BE-RWI-065` ✅, `BE-RWI-057` ✅, `BE-RWI-058` ✅ | `FE-RWI-052` ✅, `FE-RWI-053` | Backend 🟡 — empat ✅, `BE-RWI-056` sebagian; frontend FE-RWI-052 ✅ selesai 7 September 2026 [laporan](../task/report/frontend/FE-RWI-052.md) |
