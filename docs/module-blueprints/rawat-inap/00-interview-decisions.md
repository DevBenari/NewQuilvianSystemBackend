...
| Pertanyaan wawancara tersisa | **0 untuk sub-modul dokter dan keperawatan** | `RWI-OQ-050` ditutup `RWI-DEC-088`; `RWI-OQ-048` ditutup `RWI-DEC-089`. Pertanyaan terbuka modul lain tidak dibahas pada pass ini |
