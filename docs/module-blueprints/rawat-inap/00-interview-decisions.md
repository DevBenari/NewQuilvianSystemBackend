...
| Fakta yang terbukti dari repository dan PRD | 16 | `RWI-FACT-001` sampai `RWI-FACT-016`. Dua terakhir dibaca langsung dari source pada Amendment Pass pemakaian alat dan Amendment Pass approval Keperawatan |
