...
| Acceptance criteria tercatat | 177 | `RWI-AC-001` sampai `RWI-AC-177`. Empat butir historis `RWI-AC-032`, `033`, `047`, dan `048` tidak current setelah `RWI-DEC-084`–`085` |
