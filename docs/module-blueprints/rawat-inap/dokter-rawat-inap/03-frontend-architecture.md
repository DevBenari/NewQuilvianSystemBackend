...
Kebutuhan layar, skema fitur, aksi per peran, dan penanganan keadaan belum dapat ditulis karena sub-modul ini belum dirancang; butir menunya pun belum ditetapkan, dan kuota sembilan butir `IA-INP-05` sudah habis dipakai `episode-rawat-inap`.
