# Flowchart Alur Utama — Sub-modul `dokter-rawat-inap` (Rawat Inap)

| Field | Value |
|---|---|
| Sub-modul | `dokter-rawat-inap` — Dokter Rawat Inap, bagian modul `rawat-inap` |
| Revision | `0.0` |
...
Urutan langkah yang dikerjakan petugas beserta jalur gagalnya belum dapat digambar karena sub-modul ini belum dirancang, dan status pada node keadaan wajib sebaris dengan `contracts/state-transition-matrix.md` yang juga belum berisi.
