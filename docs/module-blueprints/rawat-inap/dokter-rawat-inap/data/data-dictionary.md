...
Belum ada satu kolom pun yang dapat didokumentasikan di sini, karena `RWI-DEC-081` menetapkan seluruh tabel dokumentasi klinis dimiliki modul lain — kelak berkas ini berisi kolom kunci tabel berstatus `Sudah ada` beserta rujukan file model-nya, bukan tabel `Baru`.
