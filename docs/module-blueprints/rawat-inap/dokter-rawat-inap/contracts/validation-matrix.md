...
Aturan penolakan beserta pesan bagi penggunanya belum dapat ditulis karena sub-modul ini belum dirancang; batas waktu klinis yang akan mengisinya masih menunggu pemilik klinis lewat `RWI-RULE-021`.
