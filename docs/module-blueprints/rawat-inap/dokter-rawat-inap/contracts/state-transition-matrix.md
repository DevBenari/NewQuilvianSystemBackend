...
Kosakata status dokumentasi klinis belum ditetapkan karena sub-modul ini belum dirancang, dan kosakata itu wajib datang dari `ClinicalManagement` selaku pemilik tabelnya — bukan dikarang di sini.
