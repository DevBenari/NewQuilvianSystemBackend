...
Justru bagian inilah yang kelak paling berisi — sub-modul ini hampir seluruhnya berupa integrasi ke modul lain — tetapi belum dapat ditulis karena bentuk *shared inpatient clinical context resolver* pada `PRD-RWI-FINAL-001` bagian 30.3 belum dirancang.
