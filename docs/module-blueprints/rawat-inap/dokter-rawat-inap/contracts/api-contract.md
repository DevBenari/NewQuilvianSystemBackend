...
Tidak satu pun grup `[Tags(...)]`, base URL, atau endpoint dapat dituliskan karena sub-modul ini belum dirancang; endpoint yang kelak dipakainya sebagian besar milik `ClinicalManagement` dan akan ditandai `Rencana (belum tersedia)` sampai kodenya ada.
