...
| `FE-RWI-044` | 1 elemen layout — **tombol Tambah Diagnosis** | Diagnosis terstruktur wajib menyebut nomor konsultasi, sehingga hanya dapat lahir dari catatan dokter. Layar sudah menampilkan daftar masalahnya hanya-baca beserta keterangan ke mana penambahannya menempel | **`BE-RWI-068`** ⬜ | ⛔ **Masih terbuka, tetapi bukan lagi karena kontrak.** Diperiksa ulang 9 September 2026: kontrak `0.4.0` ditulis **dan disetujui** pada hari itu, sehingga `BE-RWI-068` berpindah dari ⛔ menjadi ⬜ **siap dikerjakan**. `FE-RWI-044` baru dapat dijalankan ulang setelah task itu **selesai**, bukan setelah kontraknya disetujui |
...
> | `FE-RWI-044` | 🟡 | 2026-09-08 | `BE-RWI-068` ⬜ — tombol Tambah Diagnosis. Diperiksa ulang 2026-09-09: kontraknya sudah `approved`, task backend-nya siap dikerjakan tetapi belum selesai |
