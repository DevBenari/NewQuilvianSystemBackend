...
BE-RWI-068 ⛔ belum   ──> FE-RWI-044 belum dapat dijalankan ulang ──> 🟡 tetap
                          (BE-RWI-068 sendiri masih ⛔ menunggu approval kontrak 0.4.0)
```
...
| **Dependency** | `FE-RWI-043` ✅, `BE-RWI-045` ✅. **Ditambahkan revision 3:** `BE-RWI-068` ⛔ — tombol Tambah Diagnosis tidak dapat ditutup sebelum task itu selesai. **Diperbarui 9 September 2026:** grup diagnosis sudah ditulis pada `contracts/api-contract.md` `0.4.0` bagian 2.1 berstatus `draft`, sehingga `BE-RWI-068` kini menunggu **approval** kontrak itu |
...
> | `FE-RWI-044` | 🟡 | 2026-09-08 | `BE-RWI-068` ⛔ — tombol Tambah Diagnosis. Diperiksa ulang 2026-09-09, blocker masih berdiri |
