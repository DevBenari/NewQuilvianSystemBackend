...
**Status sub-modul: `draft`.** Seluruh artefak di bawah menunggu approval manusia. Approval `0.5.0` pada 2026-09-11
tetap sah untuk isi yang tidak berubah; task `✅` tetap sah; **task baru hanya boleh diturunkan dari revision ini
setelah disetujui**.
...
| Artefak | Revision | Status | SHA-256 |
| --- | --- | --- | --- |
| [`02-backend-architecture.md`](./02-backend-architecture.md) | **`0.5`** — bagian 11 | `draft` | `9146c490b52e7a3cd22cea10c0404c2a4fa30751d2b2da116681388f3d081a16` |
| [`03-frontend-architecture.md`](./03-frontend-architecture.md) | **`0.4`** — bagian 10 | `draft` | `80a370d1839998c42ba08f0fe484ae04b08ec3553cc7b1210a1eba16b118aa89` |
| [`04-prd-to-mvp.md`](./04-prd-to-mvp.md) | **`0.4`** — bagian 22 | `draft` | `4659cad4a3e1078855bc89738a6af30bb1b7f3f08f28dbddbf54e83594bfc215` |
| [`flowcharts/00-alur-utama.md`](./flowcharts/00-alur-utama.md) | **`0.3`** — bagian 4 | `draft` | `bed82d2b263a39da437da3f372f09f3dcec8d2f398e792ee00f797f6ee3f9054` |
...
| [`flowcharts/03-penulisan-penguncian-dan-catatan-saya.md`](./flowcharts/03-penulisan-penguncian-dan-catatan-saya.md) | **`0.3`** — baru | `draft` | `d70109d59ef688d35e2bf6bdb084c4b34c6b1caef3f4ba2bd9e3b45b134461c4` |
| [`flowcharts/04-resep-rekonsiliasi-dan-sliding-scale.md`](./flowcharts/04-resep-rekonsiliasi-dan-sliding-scale.md) | **`0.3`** — baru | `draft` | `458087d55fff5722e4ebd9527ce79b69bc0fbc37ccaf350b6d8525bbb53aac94` |
| [`flowcharts/05-pesanan-tindakan-dan-verifikasi-instruksi.md`](./flowcharts/05-pesanan-tindakan-dan-verifikasi-instruksi.md) | **`0.3`** — baru | `draft` | `7960114f2d9dfb5dff59d04f253dbe0541fd776663c35989d564d531a3333c23` |
| [`data/data-dictionary.md`](./data/data-dictionary.md) | **`0.5`** — bagian 13 | `draft` | `e63b4eea3ee97f9eb993f7362bc1d26471a9ed202eb0df943af1a28cbb216779` |
| [`contracts/api-contract.md`](./contracts/api-contract.md) | **`0.6.0`** — bagian 12 | `draft` | `318ef4b05db79e5e23ada1e1e5e2cfe8cfab24426df2a5391a0151076dc76b59` |
| [`contracts/state-transition-matrix.md`](./contracts/state-transition-matrix.md) | **`0.6.0`** — bagian 8 | `draft` | `a91fb0ef423cb9a3af9eaa6bc83273539557d9d2edb6a2683df2ac1bd11d4dca` |
| [`contracts/validation-matrix.md`](./contracts/validation-matrix.md) | **`0.6.0`** — bagian 10 | `draft` | `bed5d8042f0aa89f8c1abe9824dc8e8935c1fde5e7c3ce7c9539f673731f962b` |
| [`contracts/integration-contract.md`](./contracts/integration-contract.md) | **`0.6.0`** — bagian 12 | `draft` | `a313360f2d6d763b3db380c1a9149f87f8a21feb1bf53571753719e0f1dbae7d` |
| [`contracts/permission-audit-matrix.md`](./contracts/permission-audit-matrix.md) | **`0.6.0`** — bagian 6 s.d. 9 | `draft` | `84732dddd9703be550e834bf1a7ae35bd3f63aace2b6831eeb8ef664a1a50e58` |
| [`testing/acceptance-test-matrix.md`](./testing/acceptance-test-matrix.md) | **`0.6.0`** — bagian 12 s.d. 14 | `draft` | `3d7f69bb535caaa392de2701e9ca2c8e0b5c8e7b436ee9d38b98131cf3c977e9` |
...
| `next_owner` | Approval pemilik atas revision `7`; setelah itu `plan-module-delivery` untuk `DOK-V2-0` s.d. `DOK-V2-4` |
