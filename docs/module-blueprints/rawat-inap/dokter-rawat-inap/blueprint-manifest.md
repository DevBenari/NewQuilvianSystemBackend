...
| `contract_versions` | **`0.5.0`** sesuai `RWI-DEC-105` 2026-09-11 (api-contract, permission-audit-matrix, state-transition-matrix, acceptance-test-matrix). Baris `status` di atas dan tabel bagian 4 masih menulis `0.4.0` dan **basi** — dicatat 2026-09-14, dibetulkan saat amandemen berikutnya |
