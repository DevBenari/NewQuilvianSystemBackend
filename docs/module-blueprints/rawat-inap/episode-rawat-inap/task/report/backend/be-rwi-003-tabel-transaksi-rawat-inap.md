...
| Trace | [`02-backend-architecture.md`](../../../02-backend-architecture.md) revision `0.4` §3, §4.1 s.d. §4.11, §6, §7.1; `INV-INP-01` s.d. `INV-INP-10`; [`data/data-dictionary.md`](../../../data/data-dictionary.md) revision `0.4`; `RWI-DEC-054` s.d. `RWI-DEC-057`, `RWI-DEC-065`, `RWI-DEC-073` |
