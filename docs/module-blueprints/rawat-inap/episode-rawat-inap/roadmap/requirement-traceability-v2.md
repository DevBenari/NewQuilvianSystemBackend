...
| `FR-RI-197` | `RI-40` | `NFR-027` | `02-backend` 11 | API 10.3 | `BE-RWI-086` | `FE-RWI-064` | Acceptance 18.3; `UAT-49` | ✅ Terbukti di frontend (🟡 sebagian di backend). Usulan berlabel sumber, tidak menyimpan otomatis (zero-persistence), tahan sumber unavailable, dan form terlindungi. Di backend pengukuran waktu nyata `NFR-027` belum dijalankan pada data riil. [BE-RWI-086](../task/report/backend/BE-RWI-086.md), [FE-RWI-064](../task/report/frontend/FE-RWI-064.md) |
