...
- **Status:** ✅ **Selesai** (17 September 2026) — Laporan: [`FE-RWI-095.md`](../task/report/frontend/FE-RWI-095.md)
...
- **Definition of Done (DoD):** Komponen unit test render lulus (4/4 PASS), file tersimpan di `src/components/features/health-services/inpatient-management/billing-integration/billing-status-badge.jsx` dan alias `src/components/features/inpatient/billing-integration/BillingStatusBadge.jsx`. ESLint 0 error, build Next.js PASS.

### Kartu `FE-RWI-096`: Integrasi Sensus & Detail Pasien
- **Status:** ✅ **Selesai** (18 September 2026) — Laporan: [`FE-RWI-096.md`](../task/report/frontend/FE-RWI-096.md)
...
- **Definition of Done (DoD):** Komponen `BillingSummaryCard.jsx` dan hook `useInpatientBillingStatus` terpasang, re-export alias tersedia, unit test lulus (5/5 PASS), ESLint 0 error, verifikasi tampilan di layar sensus dan detail episode berhasil. Laporan: [`FE-RWI-096.md`](../task/report/frontend/FE-RWI-096.md).

### Kartu `FE-RWI-097`: Drawer Rincian Finansial Berizin
- **Status:** ✅ **Selesai** (18 September 2026) — Laporan: [`FE-RWI-097.md`](../task/report/frontend/FE-RWI-097.md)
- **Outcome:** Panel rincian finansial kasir dapat dibuka hanya oleh pemegang permission `InpatientBilling:View`.
- **Kriteria Penerimaan (AC):**
  1. Tombol "Buka Rincian Finansial" hanya muncul jika user memiliki permission `InpatientBilling:View`.
...
- **Definition of Done (DoD):** Komponen `BillingFinancialDetailsDrawer.jsx` terpasang, re-export alias tersedia, pengetesan izin peran kasir vs perawat lulus (4/4 PASS), ESLint 0 error, verifikasi format IDR berhasil. Laporan: [`FE-RWI-097.md`](../task/report/frontend/FE-RWI-097.md).

### Kartu `FE-RWI-098`: Gerbang Pemulangan Fisik & Auto-Reblock
- **Status:** ✅ **Selesai** (18 September 2026) — Laporan: [`FE-RWI-098.md`](../task/report/frontend/FE-RWI-098.md)
...
- **Definition of Done (DoD):** Verifikasi interaksi modal saat status pending, cleared, dan revoked lulus 100% (5/5 PASS), ESLint 0 error, anti-regresi PASS. Laporan: [`FE-RWI-098.md`](../task/report/frontend/FE-RWI-098.md).

### Kartu `FE-RWI-099`: Modal Supervisor Override Kedaruratan
- **Status:** ✅ **Selesai** (18 September 2026) — Laporan: [`FE-RWI-099.md`](../task/report/frontend/FE-RWI-099.md)
...
- **Definition of Done (DoD):** Komponen `SupervisorOverrideModal.jsx` terpasang, re-export alias tersedia, service `submitSupervisorOverride` terintegrasi, unit test lulus 100% (5/5 PASS), ESLint 0 error, verifikasi token CSS anti-regresi PASS. Laporan: [`FE-RWI-099.md`](../task/report/frontend/FE-RWI-099.md).

### Kartu `FE-RWI-100`: Konfirmasi Kepulangan Fisik & Pelepasan Bed
- **Status:** ✅ **Selesai** (18 September 2026) — Laporan: [`FE-RWI-100.md`](../task/report/frontend/FE-RWI-100.md)
...
- **Definition of Done (DoD):** Komponen `PhysicalDischargeConfirmModal.jsx` terpasang, re-export alias tersedia, service `confirmPhysicalDischarge` terintegrasi, unit test lulus 100% (5/5 PASS), ESLint 0 error, verifikasi token CSS anti-regresi PASS. Laporan: [`FE-RWI-100.md`](../task/report/frontend/FE-RWI-100.md).
