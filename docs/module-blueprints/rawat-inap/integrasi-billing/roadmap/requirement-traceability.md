...
| **`FR-INT-005`** | `EPIC-INT-02`<br>(`INT-CAP-02`) | `RWI-DEC-159` | `02-backend` §2.2 & §5 | `contracts/state` §2 | `BE-RWI-134` | `FE-RWI-100` ✅ | `RWI-AC-239`<br>`UAT-INT-013` | ✅ Selesai Penuh (BE & FE) |
| **`FR-INT-006`** | `EPIC-INT-02`<br>(`INT-CAP-02`) | `RWI-DEC-159` | `02-backend` §3 & §5 | `contracts/integration` §1.2 | `BE-RWI-134` | `FE-RWI-100` ✅ | `RWI-AC-239`<br>`UAT-INT-013` | ✅ Selesai Penuh (BE & FE) |
...
| **`FR-INT-011`** | `EPIC-INT-04`<br>(`INT-CAP-04`) | `RWI-DEC-160` | `02-backend` §4, `03-fe` §4 | `contracts/api` §1 | `BE-RWI-132` | `FE-RWI-095` ✅, `096` ✅ | `RWI-AC-240`<br>`TC-PRIVACY-01` | ✅ Selesai Penuh (BE & FE) |
| **`FR-INT-012`** | `EPIC-INT-04`<br>(`INT-CAP-04`) | `RWI-DEC-160` | `03-frontend` §4, `05-skema` §1, 2 | `contracts/api` §1 | `BE-RWI-132` | `FE-RWI-095` ✅, `096` ✅ | `RWI-AC-240`<br>`UAT-INT-008` | ✅ Selesai Penuh (BE & FE) |
| **`FR-INT-013`** | `EPIC-INT-04`<br>(`INT-CAP-04`) | `RWI-DEC-160` | `02-backend` §4, `05-skema` §5 | `contracts/permission` §1, 2 | `BE-RWI-132` | `FE-RWI-097` ✅ | `RWI-AC-240`<br>`TC-PRIVACY-02` | ✅ Selesai Penuh (BE & FE) |
| **`FR-INT-014`** | `EPIC-INT-05`<br>(`INT-CAP-05`) | `RWI-DEC-158` | `02-backend` §5, `03-fe` §4.2 | `contracts/validation` `VAL-INT-001` | `BE-RWI-134` | `FE-RWI-098` ✅ | `RWI-AC-238`<br>`UAT-INT-012` | ✅ Selesai Penuh (BE & FE) |
| **`FR-INT-015`** | `EPIC-INT-05`<br>(`INT-CAP-05`) | `RWI-DEC-158` | `02-backend` §5, `03-fe` §4.2 | `contracts/api` §2 (Webhook) | `BE-RWI-133` | `FE-RWI-098` ✅ | `RWI-AC-238`<br>`TC-GATE-02` | ✅ Selesai Penuh (BE & FE) |
| **`FR-INT-016`** | `EPIC-INT-05`<br>(`INT-CAP-05`) | `RWI-DEC-158` | `02-backend` §5, `05-skema` §4 | `contracts/validation` `VAL-INT-004`, `005` | `BE-RWI-134` | `FE-RWI-099` ✅ | `RWI-AC-238`<br>`TC-GATE-03`, `04` | ✅ Selesai Penuh (BE & FE) |
