...
| **`AC-PLT-003`** | 🟡 `PLT-BE-004` | Uji **ada dan compile**; **belum pernah dijalankan** — `QUILVIAN_BILLING_TEST_DB` kosong |
| **`AC-PLT-004`**, `AC-PLT-005` | 🟡 `PLT-BE-004` | Uji **ada dan compile**; **belum pernah dijalankan** |
...
| **`AC-PLT-012`** | 🟡 `PLT-BE-004` | Uji **ada dan compile**; **belum pernah dijalankan** |
...
**tidak dapat** dibuktikan tanpa PostgreSQL yang berjalan, dan seluruhnya milik `PLT-BE-004`.
...
| — terbukti | **8** dari 12 |
| — menuntut PostgreSQL berjalan | 4 — **uji-nya sudah ditulis**, tinggal dijalankan |
