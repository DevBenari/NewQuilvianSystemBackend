...
| `PendingReview` | Nyatakan tidak layak | `NotUsable` | **Kewenangan operasional BDRS** (`DEC-BD-043` bentuk, `DEC-BD-045` peran) — peran yang sama dengan pengembalian ke PMI, butir hak aksesnya tetap terpisah | Kelayakan dinyatakan manusia (`INV-BD-013`); alasan wajib | `VAL-BD-082` kewenangan · `VAL-BD-016` |
