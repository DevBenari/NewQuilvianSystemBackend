...
| — 🟡 sebagian, menunggu validasi runtime | 1 — `BE-BD-006` **PARTIAL — READY FOR RUNTIME VALIDATION** per 14 September 2026; runtime acceptance 0 dari 9 `PENDING`. **Riwayat:** 🟡 pending, siap dijadwalkan — `BE-BD-006` sejak roadmap revisi 10; 0 sesudah `BE-BD-015` 🟡; 1 — `BE-BD-015`, sejak roadmap revisi 9; sebelumnya 0 sesudah `BE-BD-012` ✅; sebelumnya 1 — `BE-BD-012` sejak roadmap revisi 8; sebelumnya 0 sesudah `BE-BD-012` ⛔; sebelumnya `BE-BD-012`; sebelumnya `BE-BD-003` |
