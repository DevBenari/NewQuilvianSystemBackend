...
| Roadmap frontend | Revisi 8 **`APPROVED`** — `Sukmagp` 18 September 2026. `BD-UI-GAP-003` diserap ke acceptance `FE-BD-002`, `FE-BD-005`, `FE-BD-008`, dan `FE-BD-009`. `BD-UI-GAP-002` **ditutup penuh 18 September 2026** lewat `FE-BD-006` ✅; nol gap UI terbuka. **Riwayat:** `BD-UI-GAP-002` tetap gap implementasi, bukan penahan approval; `FORWARD-TEST / DRAFT`, butuh approval | Metadata `frontend-roadmap.md` |
...
| --- | --- | --- | --- |
| **`DONE`** — 16 dari 16, 18 September 2026 | **`IN_PROGRESS`** — 3 ✅, 0 🟡, 9 belum | `NOT_STARTED` | **`IN_PROGRESS`** |
