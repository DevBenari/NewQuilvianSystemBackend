...
| Requirement/decision | Design/contract | Backend | Frontend | Bukti | Status |
| --- | --- | --- | --- | --- | --- |
| Siklus hidup voucher lima status (`EPIC BKC-10`; `FR-BKC-045`,`047`–`053`; `PC-DEC-001`,`003`–`009`,`011`,`013`) | `PC-DES-001`,`003`,`005`–`013`; `BIL-API-0.9`, `BIL-VALIDATION-0.8`, `BIL-STATE-0.8` | 🟡 `BE-BKC-033`, `034`,`035`,`036`,`037` | `FE-BKC-023`,`024`,`025` | `BIL-AT-064`,`065`,`066`,`067`–`075`; `UAT-28`–`33`,`35`,`42` | 🟡 **SEBAGIAN — 7 September 2026.** `BE-BKC-033` (fondasi skema) dikerjakan: 5 model + 5 EF configuration + 5 `DbSet` ditulis, seed `HasData` disiapkan, prasyarat `PC-OQ-003` ditutup. **Belum terbukti:** `dotnet build` tidak dijalankan sehingga kompilasi **belum terverifikasi**, migration **belum dibuat**, seed **belum dieksekusi**. `BE-BKC-034`–`037` belum dikerjakan, sehingga siklus hidup voucher belum dapat dijalankan maupun diuji. Bukti: [`BE-BKC-033`](../task/report/backend/BE-BKC-033.md) |
...
| Kolam anggaran, saldo berjalan, dan kedua penjaga saldo (`EPIC BKC-11`; `FR-BKC-054`–`060`; `PC-DEC-002`,`008`–`010`) | `PC-DES-004`–`006`,`011`,`014`; `BIL-VAL-047`,`048`,`054`,`055`,`057` | `BE-BKC-036`,`037` | `FE-BKC-023`,`026` | `BIL-AT-067`,`069`,`070`,`071`,`077`,`080`; `UAT-34`,`36`–`38` | **Direncanakan pass ini.** `FR-BKC-060` (kas kecil tidak menyentuh shift kasir) diuji lewat `BIL-AT-077` pada `BE-BKC-038`, bukan pada task ini — dicatat sebagai forward reference, bukan requirement yatim |
| Data induk kategori pengeluaran (`EPIC BKC-12`; `FR-BKC-061`–`063`; `PC-DEC-012`; `CAP-31`) | `PC-DES-002` | `BE-BKC-035` | `FE-BKC-027` | `BIL-AT-076`; `UAT-39`–`41` | **Direncanakan pass ini.** Nama entity `MstPettyCashCategory` mengikuti penutupan `PC-OQ-001` (`PC-DEC-014`) |
