...
| `OPS-DEC-027` | Decision | Kamar operasi bukan depo bersaldo mandiri; stoknya milik depo Farmasi dan depo sumbernya ditentukan pemetaan `MstOperatingRoomStockSource`, bukan konstanta di dalam kode | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Keputusan `OPS-OQ-102` |
| `OPS-DEC-028` | Decision | Pemakaian material operasi dibukukan ke kartu stok Farmasi melalui outbox dan consumer yang memanggil `DrugStockService`; Farmasi tetap satu-satunya pihak yang berwenang menulis saldo | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Keputusan `OPS-OQ-102` |
| `OPS-DEC-029` | Decision | Tarif, diskon, penjaminan, dan invoice adalah milik Billing; Operasi hanya menghasilkan chargeable event berupa tindakan, jasa dokter, jasa anestesi, material/implant, dan BHP | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Keputusan `OPS-OQ-103` |
| `OPS-DEC-030` | Decision | Tiga sign-off kesiapan klinis tetap berlaku; tahap `Administrative Review` boleh ditambahkan sebelum `Scheduled` bila dibutuhkan, tanpa menghapus `OPS-DEC-005` maupun `OPS-DEC-026` | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Keputusan `CAP-003` |
| `OPS-DEC-031` | Decision | Satuan pemakaian material operasi wajib merujuk `MstMeasurement` dan divalidasi terhadap satuan stok obat; satuan berbeda harus punya konversi pada `MstDrugUnitConversion`, dan satuan yang tidak dikenal tidak boleh mengurangi stok | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Keputusan `OPS-OQ-106` |
| `OPS-DEC-032` | Decision | Pembukuan outbox Inventory dijalankan sinkron atas pemicu manual dengan mekanisme retry; tanpa SLA detik, tetapi kegagalan tidak boleh menghilangkan transaksi maupun meninggalkan stok setengah berubah | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Keputusan `OPS-OQ-107` |
| `OPS-DEC-033` | Decision | Material operasi yang dikembalikan memakai alur Retur Obat Farmasi yang sudah ada sebagai perluasan, bukan alur retur tersendiri; stok bertambah hanya setelah pemeriksaan apoteker | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Keputusan `OPS-OQ-108` |
| `OPS-DEC-034` | Decision | Gerbang administratif sebelum penjadwalan tidak dibangun pada tahap ini; tiga sign-off kesiapan klinis tetap satu-satunya gerbang. Penambahannya tetap boleh kelak sesuai `OPS-DEC-030`, tanpa mengubah `OPS-DEC-005` maupun `OPS-DEC-026` | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Penutupan `OPS-OQ-101` |
| `OPS-DEC-035` | Decision | Master alat medis berbayar tidak dibangun sebelum keputusan final tersedia. Alat yang dipakai operasi dicatat sebagai material lewat master obat/alkes Farmasi yang sudah ada; harga dan tarifnya milik Billing sesuai `OPS-DEC-029` | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Penutupan `OPS-OQ-104` |
| `OPS-DEC-036` | Decision | Tipe ASA, kelompok pasien anestesi, dan recovery room tidak dijadikan data terstruktur pada tahap ini; keduanya tetap berada di dalam ringkasan asesmen anestesi berupa teks. Master anestesi kompleks tidak dibangun sebelum keputusan final | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Penutupan `OPS-OQ-105` |
| `OPS-DEC-037` | Decision | Billing bukan scope inti Modul Operasi. Tanggung jawab Operasi terbatas pada mencatat episode operasi, tindakan, material/BHP yang dipakai, dan menghasilkan data yang dapat dipakai modul lain. Integrasi Billing dicatat sebagai dependency/future integration dan dibahas saat modul Billing/Finance dikerjakan | Pemilik kebutuhan | approved | Pemilik kebutuhan, 2026-09-04 | Penetapan scope setelah audit `04-billing-dependency-audit.md` |
